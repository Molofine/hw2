<html>
    <head>
        ...
        <title>Carinterest - {{ $username }}</title>
        ...
        <script src='{{ url("js/salvati.js") }}' defer="true"></script>
    ...
    <body>
        ...
        <h6>Qui sono salvati tutti i tuoi caricamenti</h6>
        ...
        <section id="delete">
            ...
            <h6>Attenzione! non sarà più possibile recuperare il profilo, gli upload e i preferiti</h6>
        </section>
